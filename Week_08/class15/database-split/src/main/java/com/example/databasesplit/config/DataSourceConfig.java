package com.example.databasesplit.config;
...
public class DataSourceConfig {
    public DataSource db0() {
        ...
        configuration.setJdbcUrl("jdbc:mysql://49.232.214.119:3306/db0");
        configuration.setUsername("db0");
        configuration.setPassword("db0");
    ...
    public DataSource db1() {
        HikariConfig configuration = new HikariConfig();
        configuration.setDriverClassName("com.mysql.jdbc.Driver");
        configuration.setJdbcUrl("jdbc:mysql://49.232.214.119:3306/db1");
        configuration.setUsername("db1");
        configuration.setPassword("db1");
        return new HikariDataSource(configuration);
    }


    public ShardingTableRuleConfiguration orderTableRuleConfig() {
        ShardingTableRuleConfiguration orderTableRuleConfig = new ShardingTableRuleConfiguration("t_order", "db${0..1}.t_order${0..15}");
