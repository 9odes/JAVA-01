...
public class InsertDemo {
    private static final String URL = "jdbc:mysql://localhost:3306/hitest?serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    private static final String USER_NAME = "hitest";
    private static final String PASSWORD = "hitest";
...
//        //多线程调用方法2 本机测试约8s-9s
    ...
    public static int addChunk(int length, Connection conn) throws SQLException {
        String sql = "INSERT INTO `hitest`.`order`(`order_id`, `product_code`, `user_name`, `count`, `unit_price`, `real_price`) VALUES"+getValuesPart(length);
